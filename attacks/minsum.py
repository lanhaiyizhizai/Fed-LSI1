"""Min-Sum attack from 'Manipulating the Byzantine' (NDSS 2022)."""
import torch


def minsum_attack(benign_updates, n_attackers, device='cpu', dev_type='unit_vec'):
    """
    Min-Sum attack: craft malicious updates that minimize the sum of distances.
